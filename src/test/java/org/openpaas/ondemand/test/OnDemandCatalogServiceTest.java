package org.openpaas.ondemand.test;
...
import org.openpaas.ondemand.config.BrokerConfig;
import org.openpaas.ondemand.config.CatalogConfig;
import org.openpaas.ondemand.config.RestTemplateConfig;
import org.openpaas.ondemand.service.impl.OnDemandCatalogService;
...
public class OnDemandCatalogServiceTest {
    ...
    public void getCatalog() throws Exception {
        ...
        ReflectionTestUtils.setField(catalogConfig, "SERVICEDEFINITION_DESC", "\"A Application Platform source control service for application development.provision parameters : parameters {owner : owner}\"");
